...
$root = rtrim($_SERVER['DOCUMENT_ROOT'] . '/newredtree/public/','/'); // don't touch this configuration
...
$base_url="http://localhost/newredtree/public"; //url base of site if you want only relative url leave empty
$upload_dir = '/uploads/source/'; // path from base_url to upload base dir
$current_path = '../../../../../uploads/source/'; // relative path from filemanager folder to upload files folder
