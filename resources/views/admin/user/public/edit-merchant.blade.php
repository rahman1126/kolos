    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="header">
                        <h4 class="title">My Company</h4>
                    </div>
                    <div class="content">
                        @if($user->merchant->active == 0)
                        <p class="alert alert-danger">
                            <i>Your company is not active yet or still in moderation. Which means wont appear on the app until get activated. please contact KOLOS for more information.</i>
                        </p>
                        @endif
                        <form action="{{ url('home/profile/merchant/update') }}" method="post" enctype="multipart/form-data">
                            <!-- <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <!-- <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Full Name" value="{{ $user->name }}" readonly>
                                        @if ($errors->has('name'))
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                                        ...
                                        <select name="category" class="selectpicker" disabled>
                                            <option value="">Choose One</option>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" rows="5" class="form-control" placeholder="Here can be your description">{{ (old('description') == '' ? $user->merchant->description : old('description')) }}</textarea>
