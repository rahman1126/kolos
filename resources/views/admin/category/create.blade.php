        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="content">
                        <form action="{{ url('home/category/store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-4">
                <div class="card card-user">
                    <div class="image merchant">
                        <img id="btn-upload-cover" src="http://dummyimage.com/300x300/d1d1d1/ffffff.jpg&text=Cover+Image" alt="..."/>
                    </div>
                    <div class="content">
                        <div class="author merchant">
                             <a href="#">
                            <img id="btn-upload-logo" class="avatar merchant" src="http://dummyimage.com/300x300/d1d1d1/ffffff.jpg&text=Logo+Image" alt="Merchant Logo"/>

                              <h4 class="title">Create Name</h4>
                            </a>
                        </div>
