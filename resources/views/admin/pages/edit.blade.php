...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="content">
            <form action="{{ url('home/page/update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                    ...
                    <textarea type="text" name="description" id="description" class="form-control" rows="10">{{ $page->description }}</textarea>
